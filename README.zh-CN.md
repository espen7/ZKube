...
<p align="center">
  <strong>面向 Apache ZooKeeper 的 Windows 优先桌面工作台。</strong>
</p>
...
当前项目以 **Windows 桌面体验** 为优先目标，希望提供一个更现代、更专注、更适合日常使用的 ZooKeeper 工作台。
...
- Node.js 20 或更高版本
- npm
- 建议在 Windows 环境下开发和打包，以保持和当前目标平台一致
...
- 更严格的连接导入校验与保护
- 更丰富的节点比较与恢复能力
- 在 Windows-first 体验稳定后再推进更多平台支持
